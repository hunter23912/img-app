...
const starterPresets: PromptPreset[] = [
  {
    ...
    scope: 'edit',
    prompt:
      '移除图片中的所有文字、Logo 和水印，并根据周围纹理、光影和透视自然补全缺失区域。保持主体、构图、色彩和图片尺寸不变，不添加新的元素或文字。',
  },
  {
    ...
    scope: 'edit',
    prompt:
      '去除人物脸部的贴图、表情贴纸、马赛克和遮挡元素，根据脸部轮廓、五官、皮肤纹理、光影和透视自然还原。保持人物身份特征、表情、发型、姿态、构图和画面风格不变，不添加额外文字或装饰。',
  },
  {
    ...
    scope: 'edit',
    prompt:
      '提升图片清晰度、细节和质感，修复模糊、噪点、压缩痕迹和锯齿。保持原有内容、人物特征、构图、色彩和风格不变，效果自然，避免过度锐化。',
  },
  {
    ...
    scope: 'edit',
    prompt:
      '减少 GPT Image 2 系列模型生成图中常见的鱼鳞状纹理、碎片状褶皱、重复片状细节和不自然的表面噪声。让皮肤、衣物、头发和背景纹理连续、干净、自然，保持主体、构图、色彩和整体风格不变，避免过度磨皮或锐化。',
  },
  {
  ...
  {
    id: 'starter-commercial-poster',
    name: '商业海报',
    scope: 'generate',
    prompt:
      '生成一张具有专业商业设计感的主题海报。主体突出，信息层级清晰，为标题和正文预留合理的排版空间，画面构图完整、光影统一，适合高质量印刷与社交媒体发布。',
  },
  {
    id: 'female-generate',
    name: '角色生成',
