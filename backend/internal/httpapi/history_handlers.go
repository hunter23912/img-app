...
func databaseHistoryHandler(w http.ResponseWriter, r *http.Request, database *appDatabase) {
	...
	switch r.Method {
	case http.MethodGet:
		if imageID, ok := history.ParseImagePath(r.URL.Path); ok {
...
func deleteHistoryImage(w http.ResponseWriter, r *http.Request, memoryHistory *imageHistory) {
